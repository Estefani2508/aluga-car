...
class AlugarVeiculo(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.entryAno.grid(row=2,column=1, padx=10, pady=10, sticky='w')
        ...
        self.comboCliente = ctk.CTkEntry(self.frameItens, font=('Open Sans', 16), width=300, state='disabled')
        self.comboCliente.grid(row=1,column=3, padx=10, sticky='w')
